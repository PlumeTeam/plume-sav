import type { Database, TicketStatus, RequestStatus, ServiceType, ProblemCategory, UrgencyLevel, PhotoType, MessageSenderRole, SchoolResolution, ClosureOutcome } from '@plume/db'
