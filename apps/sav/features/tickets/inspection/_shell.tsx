...
// Primitives UI partagées par tous les écrans du wizard d'inspection école.
// Extrait du monolithe CheckWizard.tsx — la logique de state vit toujours
// dans le wizard, ces composants sont purement présentationnels.
