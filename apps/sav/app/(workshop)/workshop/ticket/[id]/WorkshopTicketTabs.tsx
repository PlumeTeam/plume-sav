...
/**
 * Trois onglets côté atelier : État (parcours physique de l'aile), Diagnostic
 * (travail technique + saisie), Messages (canaux Client / École). Calqué sur
 * `SchoolTicketTabs` pour cohérence UX/ARIA entre les deux espaces.
 */
    ...
    <>
      ...
      >
        ...
        <button
          ...
          aria-controls="panel-diagnostic"
          id="tab-diagnostic"
