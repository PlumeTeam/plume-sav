...
import { getWorkshopUnreadTotal } from '@/features/tickets/messages-unread-workshop'

export async function WorkshopMessagesNavButton() {
  const supabase = await createClient()
  const unread = await getWorkshopUnreadTotal(supabase)
