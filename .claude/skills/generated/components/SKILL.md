...
| `AdminTicketActions` | Function | `apps/sav/app/(plume)/plume/AdminTicketActions.tsx` | 20 |
| `close` | Function | `apps/sav/app/(plume)/plume/AdminTicketActions.tsx` | 39 |
| `ScanGateModal` | Function | `apps/sav/features/tickets/components/ScanGateModal.tsx` | 62 |
| `checkSerial` | Function | `apps/sav/features/tickets/components/ScanGateModal.tsx` | 79 |
| `handleCameraDecode` | Function | `apps/sav/features/tickets/components/ScanGateModal.tsx` | 84 |
| `handleManualConfirm` | Function | `apps/sav/features/tickets/components/ScanGateModal.tsx` | 97 |
...
| `startCamera` | Function | `apps/sav/features/tickets/components/QRCameraScanner.tsx` | 61 |
