...
- **`reset`** (Function) — `apps/sav/features/tickets/components/wizard/WingScanCard.tsx:96`
...
| `WingScanCard` | Function | `apps/sav/features/tickets/components/wizard/WingScanCard.tsx` | 62 |
| `findWingBySerial` | Function | `apps/sav/features/tickets/components/wizard/WingScanCard.tsx` | 65 |
| `resolveSerial` | Function | `apps/sav/features/tickets/components/wizard/WingScanCard.tsx` | 70 |
| `handleCameraDecode` | Function | `apps/sav/features/tickets/components/wizard/WingScanCard.tsx` | 83 |
| `runDemoScan` | Function | `apps/sav/features/tickets/components/wizard/WingScanCard.tsx` | 90 |
